...
For the frontend, you’ll need some .pkl files. I’ve added one of them here. Also, for movie similarity, you’ll need another .pkl file. You can generate it by referring to the app.py and movieRecommender.ipynb files.
